...
?>
	<div class="wrap">
		...
		<?php _e("To administer your Visitors Voice account, you need to login to <a href='http://service.visitorsvoice.com/' target='_new'>Visitors Voice Dashboard", "visitorsvoice"); ?></a>.
		</br></br>
